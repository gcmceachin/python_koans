...
# I miss understood what I was supposed to do. The test is asking for true or false.
...
"""
    ...
    def test_plus_concatenates_strings(self):
        string = "Hello, " + "world"
        self.assertEqual("Hello, world", string)
# Missed the stupid Comma!! the plus has no value so it is undefined.
...
# I let the conformity trick me and did't put the quotations where they were supposed to go
    def test_plus_equals_will_append_to_end_of_string(self):
        hi = "Hello, "
        there = "world"
        hi += there
        self.assertEqual("Hello, world", hi)
# I caplitalized world because I was not paying attention, yet another typo.
