...
class AboutTuples(Koan):
    ...
    def test_tuples_are_immutable_so_item_assignment_is_not_possible(self):
        ...
        # didn't use the tuple the first time...'
    ...
    def test_tuples_of_one_look_peculiar(self):
        ...
        # the double parentheses totally through me off goggled and found gregmalcolms exlination

    def test_tuple_constructor_can_be_surprising(self):
        self.assertEqual(('S','u','r','p','r','i','s','e','!'), tuple("Surprise!"))

        # missed the double parens and forgot the exclamation point
    ...
    def test_tuples_can_be_embedded(self):
        ...
        # capitalization is apprently important
